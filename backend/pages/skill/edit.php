              ...
              <div class="card-body">
                ...
                <form action="../../actions/skill/update.php?id=<?= $skill->id ?>" method="POST">
                  <div class="mb-3">
                    ...
                    <input type="text" name="skill" id="skillInput" class="form-control" placeholder="Masukkan skill..." required value="<?= $skill->skill ?>">
                  </div>
                  <div class="mb-3">
                        <label for="descriptionInput" class="form-label">Deskripsi</label>
                        <textarea name="description" id="descriptionInput" class="form-control" rows="4" placeholder="Masukkan deskripsi..." required><?= $skill->description ?></textarea>
                      </div>
                  <div class="mb-3">
                    <label for="percentInput" class="form-label">Percent</label>
                    <input type="number" name="percent" id="percentInput" class="form-control" placeholder="Masukkan persentase..." min="0" max="100" required value="<?= $skill->percent ?>">
                  </div>
